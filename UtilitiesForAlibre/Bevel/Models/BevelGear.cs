...
namespace Bolsover.Bevel.Models
{
    public class BevelGear : IBevelGear, INotifyPropertyChanged
    {
        ...
        private const string threeZeroIn = threeZero + " in";
        private const string threeZeroMm = threeZero + " mm";
        private const string threeZeroDeg = threeZero + "°";
        ...
        // public double ToImperial(double mm)
        // {
        //     return mm / mmToIn;
        // }
        //
        // public string ToMmFormat(double mm)
        // {
        //     return mm.ToString(threeZeroMm);
        // }
        //
        // public string ToInFormat(double mm)
        // {
        //     return ToImperial(mm).ToString(threeZeroIn);
        // }
        //
        // public string ToDegFormat(double angleDeg)
        // {
        //     return angleDeg.ToString(threeZeroDeg);
        // }
        //
        // public string ToFormat(double d, string format)
        // {
