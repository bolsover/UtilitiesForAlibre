...
namespace Bolsover.Involute.Calculator
{
    public class ProfileShiftedIntExtSpurGearCalculator : IGearCalculator
    {
        ...
        public ProfileShiftedIntExtSpurGearCalculator(IGearPairDesignInputParams designInputParams,
        ...
        public void Calculate()
        {
            ...
            var epsilonGamma =
                CalculateContactRatioAlpha(_designInputParams); // Contact Ratio gamma ia always equal to alpha
            ...
            IGearPairDesignOutputParams pairDesignOutputParams)
        {
            ...
            gearData.Add(new GearData("Module", pinionIn.Module.ToString("0.000"),
                ...
                (Math.PI / (25.4 / pinionIn.Module)).ToString("0.0000 in CP"), false));
            ...
            gearData.Add(new GearData("Pressure Angle: ", pinionIn.PressureAngle.ToString("0.000°"),
                pinionIn.PressureAngle.ToString("0.000°"), null,
                IsError(pinionIn.PressureAngle)));
            ...
            gearData.Add(new GearData("Addendum: ", pinionOut.Addendum.ToString("0.000 mm"),
                (pinionOut.Addendum / 25.4).ToString("0.0000 in"), null,
                IsError(pinionOut.Addendum)));
            gearData.Add(new GearData("Dedendum: ", pinionOut.Dedendum.ToString("0.000 mm"),
                (pinionOut.Dedendum / 25.4).ToString("0.0000 in"), null,
                IsError(pinionOut.Dedendum)));
            ...
            gearData.Add(new GearData("Pressure Angle: ", gearIn.PressureAngle.ToString("0.000°"),
                gearIn.PressureAngle.ToString("0.000°"), null,
                IsError(gearIn.PressureAngle)));
            ...
            gearData.Add(new GearData("Addendum: ", gearOut.Addendum.ToString("0.000 mm"),
                (gearOut.Addendum / 25.4).ToString("0.0000 in"), null,
                IsError(gearOut.Addendum)));
            gearData.Add(new GearData("Dedendum: ", gearOut.Dedendum.ToString("0.000 mm"),
                (gearOut.Dedendum / 25.4).ToString("0.0000 in"), null,
                IsError(gearOut.Dedendum)));
            gearData.Add(new GearData("Whole Depth: ", gearOut.WholeDepth.ToString("0.000 mm"),
                (gearOut.WholeDepth / 25.4).ToString("0.0000 in"),
                null, IsError(gearOut.WholeDepth)));
            gearData.Add(new GearData("Phi: ", gearOut.Phi.ToString("0.000°"), gearOut.Phi.ToString("0.000°"), null,
                IsError(gearOut.Phi)));
            gearData.Add(
                new GearData("Theta: ", gearOut.Theta.ToString("0.000°"), gearOut.Theta.ToString("0.000°"), null,
            ...
            gearData.Add(new GearData("Involute Function: ", gearOut.InvoluteFunction.ToString("0.0000"),
                gearOut.InvoluteFunction.ToString("0.0000"), null, IsError(gearOut.InvoluteFunction)));
        ...
        public double CalculateWorkingPressureAngle(IGearPairDesignInputParams pairDesignInputParams)
        {
            ...
            var alphaW = Degrees(Math.Acos((z2 - z1) * Math.Cos(alpha) /
                                           (2 * y + z2 - z1))); // Working pressure angle degrees
            return alphaW;
        }
