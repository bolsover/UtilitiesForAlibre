...
namespace Bolsover.Involute.Calculator
{
    public static class ToothPointCalculator
    {
        ...
        {
            var result = Math.Asin(gearDesignOutputParams.RootFilletDiameter /
                                   (gearDesignOutputParams.RootCircleDiameter + gearDesignOutputParams.RootFilletDiameter));
            return result;
        }
        ...
        {
            var rhSinvolute = BuildBasicInvolute(gearDesignOutputParams, 25);
            var ex = gearDesignOutputParams.RootCircleDiameter / 2 *
                     Math.Tan(AngleToRootFilletCentre(gearDesignOutputParams)) +
                     gearDesignOutputParams.RootCircleDiameter / 2 /
                     Math.Cos(AngleToRootFilletCentre(gearDesignOutputParams));
        ...
        public static GearPoint GearPointRhsEndRootRelief(IGearDesignOutputParams gearDesignOutputParams)
        {
            var rhSinvolute = BuildBasicInvolute(gearDesignOutputParams, 25);
            var x =
                gearDesignOutputParams.RootCircleDiameter / 2 * Math.Tan(AngleToRootFilletCentre(gearDesignOutputParams)) +
        ...
        {
            return Math.Asin(gearDesignOutputParams.RootFilletDiameter /
                             (gearDesignOutputParams.RootCircleDiameter + gearDesignOutputParams.RootFilletDiameter));
        }
