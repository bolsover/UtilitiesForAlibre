...
{
    public abstract class InternalHelicalGearBuilder : AlibreToothBuilder
    {
        private static BuildingGear f;
        
        public static bool BuildWork(IADDesignSession session, Tooth tooth, IGearDesignOutputParams gear)
        {
            var sketches = session.Sketches;
            var sketch = sketches.Item("Tooth");
            var figures = sketch.Figures;
            // open the sketch for changes
            f.messageLabel.Text = "Updating sketch..";
            sketch.BeginChange();
            ...
            if (gear.BaseCircleDiameter < gear.OutsideDiameter)
            {
                ...
                AddScaledCircularArcByCenterStartEnd(sketch, tooth.Points[0].Point, tooth.Points[16].Point,
                    tooth.Points[17].Point, scale);
                AddScaledCircularArcByCenterStartEnd(sketch, tooth.Points[0].Point, tooth.Points[1].Point,
                    tooth.Points[2].Point, scale);
            }
            else
            {
                ...
                AddScaledCircularArcByCenterStartEnd(sketch, tooth.Points[0].Point, tooth.Points[16].Point,
                    tooth.Points[21].Point, scale);
                AddScaledCircularArcByCenterStartEnd(sketch, tooth.Points[0].Point, tooth.Points[20].Point,
                    tooth.Points[2].Point, scale);
            }
            
            AddScaledCircularArcByCenterStartEnd(sketch, tooth.Points[3].Point, tooth.Points[4].Point, tooth.Points[2].Point,
                scale);
            AddScaledCircularArcByCenterStartEnd(sketch, tooth.Points[15].Point, tooth.Points[16].Point,
                tooth.Points[14].Point, scale);
            AddScaledCircularArcByCenterStartEnd(sketch, tooth.Points[0].Point, tooth.Points[18].Point,
                tooth.Points[19].Point, scale);
            AddScaledCircularArcByCenterStartEnd(sketch, tooth.Points[0].Point, tooth.Points[8].Point,
                tooth.Points[10].Point, scale);
            // complete the sketch changes
            sketch.EndChange();
            // open up an Alibre parameter transaction session
            f.messageLabel.Text = "Updating parameters..";
            ...
            f.messageLabel.Text = "Regenerating..";
