...
namespace Bolsover.Involute.Builder
{
    public abstract class ExternalSpurGearBuilder : AlibreToothBuilder
    {
        ...
        private static bool BuildWork(IADDesignSession session, Tooth tooth, IGearDesignOutputParams gear)
        {
            ...
            AddScaledCircularArcByCenterStartEnd(sketch, tooth.Points[0].Point, tooth.Points[1].Point, tooth.Points[2].Point,
                scale);
            ...
            AddScaledCircularArcByCenterStartEnd(sketch, tooth.Points[7].Point, tooth.Points[6].Point, tooth.Points[8].Point,
                scale);
            AddScaledCircularArcByCenterStartEnd(sketch, tooth.Points[0].Point, tooth.Points[8].Point,
                tooth.Points[10].Point, scale);
            AddScaledCircularArcByCenterStartEnd(sketch, tooth.Points[11].Point, tooth.Points[10].Point,
                tooth.Points[12].Point, scale);
