...
{
    public class FaceAreaAddOnCommand : IAlibreAddOnCommand
    {
        public FaceArea FaceArea;
        
        
        public FaceAreaAddOnCommand(IADSession session)
        {
            Session = session;
            PanelPosition = (int) ADDockStyle.AD_RIGHT;
            FaceArea = new FaceArea(session);
        }
        ...
        protected virtual long DockedPanelHandle
        {
            ...
            set
            {
                ...
                FaceArea.Parent = control;
                FaceArea.Dock = DockStyle.Fill;
                FaceArea.AutoSize = true;
                FaceArea.Show();
                control.Show();
                PanelHandle = value;
            }
        ...
        /// <summary>
        ///     Called to get the add-on to render its GDI graphics into Alibre's graphics canvas;the origin and size of the view
        ///     rectangle are passed in.
        /// </summary>
        ...
        public void OnSelectionChange()
        {
            ...
            try
            {
                if (proxy.Target.GetType() != typeof(AlibreFace)) return;
                FaceArea.Face = proxy.Target as IADFace;
            }
            catch (Exception e)
            {
                Debug.WriteLine(e);
        ...
        /// <summary>
        ///     Called when Alibre terminates the add-on command; add-on should make sure to release all references to its
        ///     CommandSite
        /// </summary>
        public void OnTerminate()
        {
            ...
            var args = new FaceAreaAddOnCommandTerminateEventArgs(this);
        ...
        public void OnComplete()
        {
            ...
            try
            {
                DockedPanelHandle = CommandSite.AddDockedPanel(PanelPosition, "Face Area Calculator");
            }
            catch (Exception ex)
            {
        ...
        /// <summary>
        ///     Returns min and max bounding box points of geometry rendered by addon; used for computing front/back clipping
        ///     planes
        /// </summary>
        ...
        public event EventHandler<FaceAreaAddOnCommandTerminateEventArgs> Terminate;
    }
}