...
namespace Bolsover.DataBrowser
{
    public partial class DataBrowserForm : Form
    {
        ...
        ///     file with the selected material. The editing row is then updated with the actual material name but this is not
        ///     saved.
        /// </summary>
        ...
        private void ConfigureAspectPutters()
        {
            ...
            ConfigureColumnAspectPutter(olvColumnAlibreCreatingApplication, ADExtendedDesignProperty.AD_CREATING_APPLICATION,
                typeof(string));
            ...
            column.AspectPutter = (rowObject, value) =>
            {
                ...
                switch (extendedDesignProperty)
                {
                    ...
                    case ADExtendedDesignProperty.AD_LAST_UPDATE_DATE:
                        ...
                        break;
                    case ADExtendedDesignProperty.AD_MODIFIED:
                        ((AlibreFileSystem) rowObject).AlibreModified = Cast(value, type);
                        break;
                    default:
        ...
        private void checkBoxFilter_CheckedChanged(object sender, EventArgs e)
        {
            if (checkBoxFilter.Checked)
            {
                treeListView.ModelFilter = new ModelFilter(rowObject => ((AlibreFileSystem) rowObject).IsDirectory ||
                                                                        ((AlibreFileSystem) rowObject).Info.Extension
                                                                        .StartsWith(".AD_"));
            }
            else
            {
        ...
        /// <summary>
        ///     Cell edit finished is used as a trigger to check if the cell contents should be copied to other cells in same
        ///     column
        /// </summary>
        /// <param name="sender"></param>
        /// <param name="e"></param>
